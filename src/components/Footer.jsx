    ...
    <>
      ...
      <div className="h-[858px] bg-[#064D51]">
        ...
        <div class='ml-9 mr-9  text-white'>
            <p className='mb-5'><strong>[Legal Name](Trading as Sapphire Broking)</strong>: Registered Office: [Registered Address]. CIN: [CIN]. SEBI Registration No.: [SEBI Registration No.] – Member of NSE, BSE, MCX, and NCDEX. Depository Participant: CDSL Registration No.: [DP Registration No.]. Compliance Officer: [Name of Compliance Officer], Tel: [Phone Number], Email: <a href="mailto:compliance@sapphirebroking.com">compliance@sapphirebroking.com</a>.</p>
            
            <p className='mb-5'><strong>Grievance Redressal:</strong> For complaints related to broking services, email us at <a href="mailto:support@sapphirebroking.com">support@sapphirebroking.com</a>. For depository-related issues, email <a href="mailto:dp@sapphirebroking.com">dp@sapphirebroking.com</a>. To escalate unresolved issues, contact our Grievance Redressal Officer: <strong>[Name]</strong>, Mobile: <strong>[Mobile Number]</strong>. Alternatively, file complaints on the SEBI SCORES portal by registering with mandatory details like Name, PAN, Address, Mobile Number, and Email ID.</p>
            
            <p className='mb-5'><strong>Cybersecurity Issues:</strong> Report cybersecurity concerns to <a href="mailto:support@sapphirebroking.com">support@sapphirebroking.com</a> or call us at <strong>[Cybersecurity Contact Number]</strong>.</p>
            
            <p className='mb-5'><strong>Regulatory Compliance:</strong> Investments in the securities market are subject to market risks. Please read all related documents carefully before investing. Brokerage will not exceed the SEBI-prescribed limit.</p>
            
            <p className='mb-5'><strong>Communication Policy:</strong> By sharing your contact details, you consent to receive communication from us via Call/SMS/Email for a period of 12 months, even if registered under DND. We use your information for legitimate business purposes only and do not sell or rent your contact details to third parties.</p>
            
            <p className='mb-2'><strong>Attention Investors:</strong></p>
